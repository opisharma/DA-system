...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($updateStmt->execute()) {
        header("Location: appointment_p_v.php?msg=updated");
        exit();
    } else {
...
<body>
    ...
    <div class="container">
        <div class="welcome-box">
            ...
            <a href="appointment_p_v.php" class="btn btn-primary">
        ...
        <div class="form-container">
            ...
            <form action="" method="post">
                ...
                <div class="mt-4">
                    ...
                    <a href="appointment_p_v.php" class="btn btn-secondary ms-2">
